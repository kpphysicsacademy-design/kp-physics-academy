...
(function(){
 ...
 function detectActive(){
  ...
  if(p==="learn.html"||/-learn\.html$/i.test(p)||/-path\.html$/i.test(p)||/full-path\.html$/i.test(p)||/neet-path\.html$/i.test(p)||/jee-path\.html$/i.test(p))return"learn";
  return"";
 }
 window.renderSkillUpNavigation=function(active){
  ...
  const items=[["home","Home"],["learn","Learn"],["practice","Practice"],["compete","League"],["profile","Profile"]];
  nav.innerHTML=items.map(([k,label])=>'<a href="'+route(k)+'" class="'+(active===k?"active":"")+'"><span>'+label+'</span></a>').join("");
 ...
 function install(){
  if(!document.getElementById("skillup-nav-style")){
   ...
   .skillup-bottom-nav a{min-width:0!important;flex:1 1 20%!important;max-width:20%!important;height:52px!important;border-radius:14px!important;text-decoration:none!important;color:#667085!important;font-size:11px!important;font-weight:800!important;display:flex!important;align-items:center!important;justify-content:center!important;line-height:1!important;padding:3px 2px!important;margin:0!important;transition:background .15s ease,color .15s ease,transform .15s ease!important}
   .skillup-bottom-nav a>span{font-size:11px!important;font-weight:800!important;line-height:1.1!important;margin:0!important;padding:0!important;white-space:nowrap!important}
   .skillup-bottom-nav a.active{color:#16a34a!important;background:#eaf8e6!important;transform:translateY(-1px)!important}
   body{padding-bottom:72px!important}
   @media(max-width:420px){.skillup-bottom-nav{padding-left:4px!important;padding-right:4px!important}.skillup-bottom-nav a{height:50px!important;border-radius:12px!important}.skillup-bottom-nav a>span{font-size:10px!important}}
