...
(function () {
  ...
  function detectActive() {
    ...
    if (page === "league.html") return "league";
  ...
  function install() {
    ...
    document.querySelectorAll("nav.bottom, nav.bottom-nav, nav.skillup-bottom-nav").forEach(n => {
      if (!n.classList.contains("skillup-bottom-nav")) n.remove();
    });
